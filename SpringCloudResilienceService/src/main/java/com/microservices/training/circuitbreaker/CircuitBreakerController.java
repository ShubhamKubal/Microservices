package com.microservices.training.circuitbreaker;
...
public class CircuitBreakerController {
    ...
    public String getInvoice() { 
       ...
       ResponseEntity<String> entity= restTemplate.getForEntity("http://localhost:8081/invoice/rest/find/2", String.class);
